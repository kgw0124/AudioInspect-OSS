...
public class MediaInfo {
	//static final String MediaInfoPath = "C:\\Users\\honglab_dbserver\\Desktop\\MediaInfo_CLI_21.03_Windows_x64\\MediaInfo.exe";
	...
	public static String getXMLString(String filePath) {
		...
		try {
			...
			Process proc = rt.exec(MediaInfoPath + MediaInfoOption + "\"" + filePath + "\"");// �ý��� ��ɾ�
